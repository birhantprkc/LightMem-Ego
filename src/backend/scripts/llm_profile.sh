...
case "${_em2mem_llm_profile}" in
  remote)
    ...
    ;;
  local-qwen35)
    # Preserve the external credentials loaded from .env before replacing the
    # process-wide OPENAI_* variables for the local answer client.
    export EM2MEM_EXTERNAL_OPENAI_API_KEY="${EM2MEM_EXTERNAL_OPENAI_API_KEY:-${OPENAI_API_KEY:-}}"
    export EM2MEM_EXTERNAL_OPENAI_BASE_URL="${EM2MEM_EXTERNAL_OPENAI_BASE_URL:-${OPENAI_BASE_URL:-}}"
    export EM2MEM_EXTERNAL_OPENAI_MODEL="${EM2MEM_EXTERNAL_OPENAI_MODEL:-${EM2MEM_MST_REFINE_MODEL:-${OPENAI_MODEL:-gpt-5.4}}}"
    ...
    export EM2MEM_LOCAL_LLM_SERVED_MODEL="${EM2MEM_LOCAL_LLM_SERVED_MODEL:-Qwen3.5-9B}"
    ...
    export EM2MEM_MEMORY_MODEL="${EM2MEM_EXTERNAL_OPENAI_MODEL}"
    export EM2MEM_QUERY_LLM_MODEL="${EM2MEM_EXTERNAL_OPENAI_MODEL}"
    export EM2MEM_QUERY_RETRIEVER_MODEL="${EM2MEM_EXTERNAL_OPENAI_MODEL}"
    ...
    export EM2MEM_MST_REFINE_MODEL="${EM2MEM_EXTERNAL_OPENAI_MODEL}"
    export EM2MEM_MST_EPISODIC_MODEL="${EM2MEM_EXTERNAL_OPENAI_MODEL}"
    export EM2MEM_VLM_MODEL="${EM2MEM_EXTERNAL_OPENAI_MODEL}"
