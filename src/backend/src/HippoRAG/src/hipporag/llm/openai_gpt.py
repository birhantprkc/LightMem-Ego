    ...
    def infer(
        ...
        **kwargs
        ...
        try:
            ...
            if "reasoning_effort" not in params or not _looks_like_unsupported_reasoning_effort(exc):
                raise
            logger.warning("Upstream rejected reasoning_effort; retrying without it: %r", exc)
